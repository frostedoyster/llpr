...
for exp_sigma in [-14, -7, -4, -1, 1, 4]:

    sigma = 10.0 ** exp_sigma

    model_with_uncertainty.set_hyperparameters(79.53690677979583, sigma)
    ...
    plt.legend()
    plt.savefig(f"outputs/figures/ood_cali_{exp_sigma}.pdf")
    plt.close()
